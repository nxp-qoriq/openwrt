...
define Device/fsl_ls1046a-db
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-DB
  DEVICE_VARIANT := Default
  DEVICE_PACKAGES += \
    layerscape-fman \
    tfa-ls1046a-db \
    fmc fmc-eth-config \
    kmod-rtc-pcf2127
  DEVICE_DTS := freescale/fsl-ls1046a-db-sdk
  IMAGE/firmware.bin := \
    ls-clean | \
    ls-append $(1)-bl2.pbl | pad-to 1M | \
    ls-append $(1)-fip.bin | pad-to 5M | \
    ...
    append-rootfs | pad-rootfs | check-size
endef
TARGET_DEVICES += fsl_ls1046a-db

define Device/fsl_ls1046a-db-sdboot
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-DB
  DEVICE_VARIANT := SD Card Boot
  DEVICE_PACKAGES += \
    layerscape-fman \
    tfa-ls1046a-db-sdboot \
    fmc fmc-eth-config \
    kmod-rtc-pcf2127
  DEVICE_DTS := freescale/fsl-ls1046a-db-sdk
  FILESYSTEMS := ext4
  ...
  IMAGE/sysupgrade.bin := \
    ...
    append-rootfs | check-size $(LS_SD_IMAGE_SIZE) | append-metadata
endef
TARGET_DEVICES += fsl_ls1046a-db-sdboot

define Device/fsl_ls1046a-db-emmcboot
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-DB
  DEVICE_VARIANT := EMMC Boot
  DEVICE_PACKAGES += \
    layerscape-fman \
    tfa-ls1046a-db-emmcboot \
    fmc fmc-eth-config \
    kmod-rtc-pcf2127
  DEVICE_DTS := freescale/fsl-ls1046a-db-sdk
  FILESYSTEMS := ext4
...
define Device/fsl_ls1046a-wrdb
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-WRDB
  DEVICE_VARIANT := Default
  DEVICE_PACKAGES += \
    layerscape-fman \
    tfa-ls1046a-wrdb \
  ...
  IMAGE/firmware.bin := \
    ...
    append-rootfs | pad-rootfs | check-size
endef
TARGET_DEVICES += fsl_ls1046a-wrdb

define Device/fsl_ls1046a-wrdb-sdboot
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-WRDB
  DEVICE_VARIANT := SD Card Boot
  DEVICE_PACKAGES += \
  ...
  IMAGE/sysupgrade.bin := \
    ...
    append-rootfs | check-size $(LS_SD_IMAGE_SIZE) | append-metadata
endef
TARGET_DEVICES += fsl_ls1046a-wrdb-sdboot

define Device/fsl_ls1046a-wrdb-emmcboot
  DEVICE_VENDOR := NXP
  DEVICE_MODEL := LS1046A-WRDB
  DEVICE_VARIANT := EMMC Boot
  DEVICE_PACKAGES += \
    layerscape-fman \
    tfa-ls1046a-wrdb-emmcboot \
    fmc fmc-eth-config \
    kmod-rtc-pcf2127
  DEVICE_DTS := freescale/fsl-ls1046a-wrdb-sdk
  FILESYSTEMS := ext4
...
define Device/fsl_lx2160a-rdb-sdboot
  ...
  IMAGE/sdcard.img := \
    ...
    ls-append fsl_lx2160a-rdb-dpc.dtb | pad-to 15M | \
    ls-append-dtb $$(DEVICE_DTS) | pad-to 16M | \
    append-kernel | pad-to $(LS_SD_ROOTFSPART_OFFSET)M | \
    append-rootfs | check-size $(LS_SD_IMAGE_SIZE)
  IMAGE/sysupgrade.bin := \
